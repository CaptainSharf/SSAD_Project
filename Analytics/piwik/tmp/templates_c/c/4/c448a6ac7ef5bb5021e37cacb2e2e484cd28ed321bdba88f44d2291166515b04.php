...
class __TwigTemplate_c448a6ac7ef5bb5021e37cacb2e2e484cd28ed321bdba88f44d2291166515b04 extends Twig_Template
{
    ...
    <form action=\"index.php?module=CoreHome&action=redirectToPaypal&idSite=1\" method=\"post\" target=\"_blank\">
        ...
        // line 27
        echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Intl_YearShort")), "html", null, true);
        echo "</div>
